...
import com.ndtdoanh.JSSGradle.domain.response.file.ResUploadFileDTO;
import com.ndtdoanh.JSSGradle.service.FileService;
import com.ndtdoanh.JSSGradle.util.annotation.ApiMessage;
import com.ndtdoanh.JSSGradle.util.error.StorageException;
...
public class FileController {
  ...
  @Value("${ndtdoanh.upload-file.base-uri}")

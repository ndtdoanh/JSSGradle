...
public class OpenAPIConfig {
  ...
  private Contact createContact() {
    return new Contact().email("ndtdk2@gmail.com").name("ndtd").url("https://github.com/ndtdoanh");
  }
  ...
  private Info createApiInfo() {
    return new Info()
        ...
        .description("This API exposes all endpoints (jss)")
    ...
    return new OpenAPI()
        ...
        .servers(
            List.of(
                ...
                createServer(
                    "https://github.com/ndtdoanh", "Server URL in Production environment")))

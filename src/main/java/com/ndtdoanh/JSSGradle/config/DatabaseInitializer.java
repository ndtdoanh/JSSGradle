...
import com.ndtdoanh.JSSGradle.repository.PermissionRepository;
import com.ndtdoanh.JSSGradle.repository.RoleRepository;
...
public class DatabaseInitializer implements CommandLineRunner {
  ...
  public void run(String... args) throws Exception {
    ...
    if (countPermissions == 0) {
      ...
      arr.add(
          new Permission(
              "Delete a subscriber", "/api/v1/subscribers/{id}", "DELETE", "SUBSCRIBERS"));
      arr.add(
          new Permission(
              "Get a subscriber by id", "/api/v1/subscribers/{id}", "GET", "SUBSCRIBERS"));
      arr.add(
          new Permission(
              "Get subscribers with pagination", "/api/v1/subscribers", "GET", "SUBSCRIBERS"));
